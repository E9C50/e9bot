...
let pro = {
    ...
    showAllRes() {
        ...
        let base = [RESOURCE_ENERGY, RESOURCE_UTRIUM, RESOURCE_LEMERGIUM, RESOURCE_KEANIUM, RESOURCE_ZYNTHIUM, RESOURCE_CATALYST, RESOURCE_OXYGEN, RESOURCE_HYDROGEN, RESOURCE_GHODIUM, RESOURCE_POWER, RESOURCE_OPS]
        // 压缩列表
        ...
        addList(bars)
        str += "<br>"
        addList([...b_grey, ...b_withe])
        addList([...b_blue, ...b_yellow])
        addList([...b_pink, ...b_green])
        str += "<br>"
        addList(c_grey)
        addList([...c_blue, ...c_yellow])
        addList([...c_pink, ...c_green])
        str += "<br>"
        str += "<br>"
        str += "<br>"
        str += "<br>"
